...
const static char* small_path = "src/shortest_path/test_data/unweighted.txt";
...
int RegisterShortestPathTests() {
  CU_TestInfo tests[] = {CU_TEST_INFO(Graph_ShortestPath_standard),
                         CU_TEST_INFO_NULL};
