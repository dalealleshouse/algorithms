...
static void WeightedIndependentSet_File() {
  _testFile("src/weighted_independent_set/test_data/input_random_10_40.txt",
            "10010000");
  _testFile("src/weighted_independent_set/test_data/input_random_48_10000.txt",
            "10101111");
  _testFile("src/weighted_independent_set/test_data/mwis.txt", "10100110");
}
