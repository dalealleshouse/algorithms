...
static void InsertOp_insert_int_as_pointer() {
  checker checkers[] = {Array_Checker, LinkedList_Checker, BinaryTree_Checker};
...
static void BuildDataStructure_inserts_correct_number_of_items() {
  size_t n = 10;
  sizer sizers[] = {NULL,           ArraySize,      ArraySize,
...
int RegisterAlgoTimerTests() {
  CU_TestInfo create_tests[] = {
      CU_TEST_INFO(InsertOp_insert_int_as_pointer),
