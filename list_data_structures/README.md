...
The following chart and table show the actual run times for `n` predecessor
...
![SELECT RUN TIMES](c/SELECT.png "SELECT RUN TIMES")
...
![RANK RUN TIMES](c/RANK.png "RANK RUN TIMES")
