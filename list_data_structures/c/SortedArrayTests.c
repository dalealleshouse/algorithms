...
{
    Array* sut = Array_Create(int_comparator, sizeof(int));
    sut->array = calloc(sizeof(int), n);

    for (size_t i = 0; i < n; i++)
        ((int*)sut->array)[i] = rand();

    qsort(sut->array, n, sizeof(int), int_comparator);
    sut->n = n;
...
static void TestFuncNullParameter(SortedArrayOp funcs[])
{
    ...
    SortedArrayOpUnary unary_funcs[]
        = { SortedArray_Min, SortedArray_Max, SortedArray_Select_Unary, NULL };
...
static void SortedArray_null_parameter()
{
    SortedArrayOp funcs[] = { SortedArray_Search, SortedArray_Successor,
        SortedArray_Predecessor, SortedArray_Rank_ArrayOp, NULL };
...
int register_sorted_array_tests()
{
    CU_TestInfo Common_tests[]
        = { CU_TEST_INFO(SortedArray_null_parameter), CU_TEST_INFO_NULL };

    CU_TestInfo Search_tests[] = { CU_TEST_INFO(SortedArray_Search_not_found),
        CU_TEST_INFO(SortedArray_Search_standard), CU_TEST_INFO_NULL };

    CU_TestInfo Min_tests[] = { CU_TEST_INFO(SortedArray_Min_empty),
        CU_TEST_INFO(SortedArray_Min_standard), CU_TEST_INFO_NULL };

    CU_TestInfo Max_tests[] = { CU_TEST_INFO(SortedArray_Max_empty),
        CU_TEST_INFO(SortedArray_Max_standard), CU_TEST_INFO_NULL };

    CU_TestInfo Predecessor_tests[] = { CU_TEST_INFO(
                                            SortedArray_Predecessor_not_found),
    ...
    CU_TestInfo Successor_tests[] = { CU_TEST_INFO(
                                          SortedArray_Successor_not_found),
    ...
    CU_TestInfo Select_tests[]
        = { CU_TEST_INFO(SortedArray_Select_out_of_bounds),
              CU_TEST_INFO(SortedArray_Select_standard), CU_TEST_INFO_NULL };

    CU_TestInfo Rank_tests[] = { CU_TEST_INFO(SortedArray_Rank_not_found),
        CU_TEST_INFO(SortedArray_Rank_empty),
        CU_TEST_INFO(SortedArray_Rank_standard), CU_TEST_INFO_NULL };
