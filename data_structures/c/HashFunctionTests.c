...
static void hash_functions_generate_non_zero()
{
    hasher funcs[] = { rotating_hash, djb_hash, mod_djb_hash, sax_hash,
        fnv_hash, oat_hash, elf_hash, farm_hash, farm_hash2, farm_hash3,
        spooky_hash, spooky_hash2, spooky_hash3, NULL };
...
static void test_compressor(hash_compressor func)
{
    const char* key = "42";
    const size_t n = 15;
    size_t sizes[] = { 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192,
        16384, 32767, 65536 };
...
int register_hash_function_tests()
{
