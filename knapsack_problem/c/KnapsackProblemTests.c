...
static void Knapsack_SolveFiles() {
  _testFile("src/data/knapsack1.txt", 2493893);
  /* _testFile("src/data/knapsack_big.txt", 4243395); */
  _testFile("src/data/input_random_11_100_10.txt", 210);
  _testFile("src/data/input_random_16_100_100.txt", 539);
  /* _testFile("src/data/input_random_44_2000000_2000.txt", 49957183); */
}
